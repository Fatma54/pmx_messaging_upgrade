...
public class PMXCommandLineTest {

	@Test
	public void testComandLineOptionHelp() {
		//Util.getLogger("extracted\\testComandLineOptionHelp.log");
		String[] args = { "--help", "" };
	...
	@Test
	public void testComandLineOptionsEmpty() {
		//Util.getLogger("extracted\\testComandLineOptionsEmpty.log");
		String[] args = { "", "" };
		PMXCommandLine.run(args);
		assertTrue(true);
	}
