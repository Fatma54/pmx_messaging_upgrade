@REM
@REM ==============================================
@REM  PMX : Performance Model eXtractor
@REM ==============================================
@REM
@REM (c) Copyright 2014-2015, by Juergen Walter and Contributors.
@REM
@REM Project Info:   http://descartes.tools/pmx
@REM
...
cd %~dp0\..
set classpath= %cd%\lib\plugins\*
java -cp %classpath% tools.descartes.pmx.console.PMXCommandLine %1 %2 %3 %4 %5 %6 %7
