...
public class MyClassOperationSignaturePair {
	 ...
	 *            The signature.
	 */
	public MyClassOperationSignaturePair(final String fqClassname, final Signature signature) {
	...
	public String toOperationSignatureString() {
		return MyClassOperationSignaturePair.createOperationSignatureString(this.fqClassname, this.signature);
	}
	 ...
	 */
	public static MyClassOperationSignaturePair splitOperationSignatureStr(final String operationSignatureStr) {
		return MyClassOperationSignaturePair.splitOperationSignatureStr(operationSignatureStr, false);
	}
	 ...
	 */
	public static MyClassOperationSignaturePair splitOperationSignatureStr(final String operationSignatureStr, final boolean javaConstructor) {
		...
		if (nameBeginIdx == -1) {
			...
			if (javaConstructor) {
				...
				if(modRetNameArr.length <2){
					System.out.println("modRetNameArr.length  "+modRetNameArr.length);
					returnType = "UNDEFINED";
					modifierList = new String[0];
				}else{
		...
		return new MyClassOperationSignaturePair(fqClassname, new Signature(opName, modifierList, returnType, paramTypeList));
	}
	...
	public boolean equals(final Object obj) {
		...
		final MyClassOperationSignaturePair other = (MyClassOperationSignaturePair) obj;
